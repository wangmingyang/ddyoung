...
class BaseDaoMysql implements BaseDaoInterface{
    ...
    public static function getInstance(){
        if(is_null(self::$instance)){
            self::$instance = new BaseDaoMysql();
        }
    ...
    public function connectDB(){
        $this->con = mysql_connect ( $this->mysql_server_name, $this->mysql_username, $this->mysql_password) or exit("mysql connection error:".mysql_error());
        mysql_select_db( $this->mysql_database,$this->con );
    ...
    public function doSql($sql){
        ...
        if(!$res){
            print_r(mysql_error($this->con));exit;
        }
        return $res;
    }
